...
public class GroundScript : NetworkBehaviour
{
    ...
    [ClientRpc]
    void RpcMakeAHole(Vector3 center, Vector3 size)
    {
        Vector2Int c = World2Pixel(center);
        int r = Mathf.RoundToInt(size.x * WidthPixel / WidthWorld);
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        var a = collision.GetComponent<CircleCollider2D>();
        RpcMakeAHole(a.bounds.center, a.bounds.size);
